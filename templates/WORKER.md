...
- If Stitch is bound for this project, use Stitch MCP directly for current design context from the linked Stitch project and screens in `.worker/stitch.json`.
